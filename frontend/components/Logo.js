        ...
        <svg width={size} height={size} viewBox="0 0 519 519" version="1.1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
            ...
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="mountain-logo" transform="translate(1.000000, 1.000000)">
                    ...
                    <use id="Oval" stroke="#979797" xlinkHref="#path-1" />
                    <g id="sky" mask="url(#mask-2)">
                        <g transform="translate(0.000000, -6.000000)" id="Rectangle">
                            <rect fill={topSky} x="0" y="0" width="517" height="158" />
                            <path 
                    ...
                    <g id="Mountain" mask="url(#mask-2)">
                        <g transform="translate(-3.000000, 155.000000)">
                            <path 
