    ...
    quilcayhuanca: {
        ...
        itinerary: {
            basic: [
                ...
                'Acclimatization day hike',
                'Acclimatization day hike',
                'Drive to the base of Quilcayhuanca, hike to first camp',
                'Hike to Laguna Tullpacocha',
                'Active rest day',
                'Hike out, stay in Huaraz',
            ...
            detailed: [
                ...
                'We will depart our hotel in Huaraz at 8am and drive with private transportaion to the base of the Quilcayhuanca valley. Here we will organize our burros and begin hiking to the base camp of Maparaju. 2-3 hours walking. All meals included.',
                'After a leisurely morning, we will pack up camp and begin hiking to Lake Tullpacocha 4,250m (13,940). Here we will make our second nights camp. All meals included.',
                ...
                'Once breakfast is finished and the camp is packed, we will begin hiking out of the Quilcayhuanca valley. Once at the entrance, our transportation will be waiting to take us back to Huaraz. Celebratory dinner provided by SierraVista Expeditions. All meals included.',
                'Depart Huaraz by bus for Lima. It is possible to fly out from Lima on this day for those with time constraints. Most flights back to North America depart late in the evening. Otherwise, stay in Lima one additional night to enjoy fresh seafood and nightlife. Dinner not included.',
                'Depart Lima for your next adventure.',
            ],
        },
    ...
    ishinca: {
        ...
        itinerary: {
            ...
            detailed: [
                ...
                'Another alpine start leaving base camp by 5 am we will climb Urus Este 5,420m (17,782ft). Once off the glacier, we return to base camp in time for lunch. All meals included.',
